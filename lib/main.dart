    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF00D494),
          primary: const Color(0xFF00D494),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const CausesSection(), // Enhanced
            const VolunteerSection(), // New Section 1
            const EventsSection(),
            const CTABar(),
            const TestimonialsSection(), // New Section 2
            const GallerySection(), // New Section 3
            const TeamSection(), // New Section 4
            const NewsSection(), // Enhanced (Blog)
            const FAQSection(), // New Section 5
            const Footer(),
          ],
        ),
      ),
...
class Header extends StatelessWidget {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          children: [
            ...
            _mobileMenuItem(context, 'Home', Icons.home_outlined, true),
            _mobileMenuItem(
              context,
              'Our Causes',
            ...
            _mobileMenuItem(context, 'Pages', Icons.article_outlined, false),
            _mobileMenuItem(context, 'Events', Icons.event_outlined, false),
            _mobileMenuItem(context, 'News', Icons.newspaper_outlined, false),
            _mobileMenuItem(
              context,
              'Contact',
  ...
  Widget _navLink(String title, {bool active = false}) {
    return Container(
        ...
        children: [
          Text(
            ...
            style: GoogleFonts.poppins(
              ...
              color: active ? const Color(0xFF00D494) : const Color(0xFF1A1A1A),
            ),
          ),
          if (active) ...[
...
class Footer extends StatelessWidget {
  ...
  Widget _footerBrandMobile() {
    return Column(
      children: [
        ...
        const SizedBox(height: 15),
        const Text(
          'Dedicated to creating a world where every child has access to basic needs.',
          textAlign: TextAlign.center,
          style: TextStyle(color: Colors.white54, height: 1.6, fontSize: 13),
        ),
        const SizedBox(height: 20),
        ElevatedButton(
          onPressed: () {},
  ...
  Widget _socialIcon(IconData icon) {
    return Padding(
      ...
      child: FaIcon(icon, size: 16, color: Colors.white30),
    );
  }
    ...
    return Expanded(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 25),
          const Text(
            'Shanti Sthapna Mission is dedicated to creating a world where every child and family has access to the basic needs of life and the opportunity to thrive.',
            style: TextStyle(color: Colors.white54, height: 1.8, fontSize: 14),
          ),
          const SizedBox(height: 30),
          ElevatedButton(
            onPressed: () {},
